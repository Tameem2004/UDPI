...
const EduTestnet = {
  ...
  const PharosDevnet = {
    id: 50002,
    name: 'PharosDevnet',
    iconUrl: 'https://timesofstartups.com/wp-content/uploads/2024/11/pharos.jpg',
    iconBackground: '#fff',
    nativeCurrency: { name: 'PharosDevnet', symbol: 'PTT', decimals: 18 },
    rpcUrls: {
      default: { http: ['https://devnet.dplabs-internal.com'] },
    },
    blockExplorers: {
      default: { name: 'pharos', url: 'https://pharosscan.xyz' },
    },
  } as const satisfies Chain;
